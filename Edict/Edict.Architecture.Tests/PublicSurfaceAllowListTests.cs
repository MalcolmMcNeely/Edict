...
public class PublicSurfaceAllowListTests
{
    ...
    static readonly HashSet<string> EdictCoreAllowList = new(StringComparer.Ordinal)
    {
        ...
        "Edict.Core.Audit.EdictAuditMessageDeserializationException",
        ...
        "Edict.Core.Correlation.CorrelationProgress", // ADR 0045: persisted-state slot on GrainEnvelope<TPayload> — permanent resident.
        ...
        "Edict.Core.Projections.ProjectionReadResult`1", // Grain-boundary read result (row/rows + status); [EditorBrowsable(Never)], returned from the public IEdictProjectionBuilder.
        ...
        "Edict.Core.Schedules.IEdictScheduleFireable", // Framework-internal grain interface for the Test Framework fire seam.
        ...
        "OrleansCodeGen.Edict.Core.Schedules.Codec_Invokable_IEdictScheduleFireable_GrainReference_2EBE5A3D",
        "OrleansCodeGen.Edict.Core.Schedules.Codec_Invokable_IEdictScheduleFireable_GrainReference_39BFA593",
        "OrleansCodeGen.Edict.Core.Schedules.Codec_Invokable_IEdictScheduleFireable_GrainReference_612CF67A",
        "OrleansCodeGen.Edict.Core.Schedules.Codec_Invokable_IEdictScheduleFireable_GrainReference_8DABBE0C",
        "OrleansCodeGen.Edict.Core.Schedules.Codec_ScheduleEntry",
        "OrleansCodeGen.Edict.Core.Schedules.Codec_ScheduleSlice",
        "OrleansCodeGen.Edict.Core.Schedules.Copier_Invokable_IEdictScheduleFireable_GrainReference_2EBE5A3D",
        "OrleansCodeGen.Edict.Core.Schedules.Copier_Invokable_IEdictScheduleFireable_GrainReference_39BFA593",
        "OrleansCodeGen.Edict.Core.Schedules.Copier_Invokable_IEdictScheduleFireable_GrainReference_612CF67A",
        "OrleansCodeGen.Edict.Core.Schedules.Copier_Invokable_IEdictScheduleFireable_GrainReference_8DABBE0C",
        "OrleansCodeGen.Edict.Core.Schedules.Copier_ScheduleEntry",
        "OrleansCodeGen.Edict.Core.Schedules.Copier_ScheduleSlice",
        "OrleansCodeGen.Edict.Core.Schedules.Invokable_IEdictScheduleFireable_GrainReference_2EBE5A3D",
        "OrleansCodeGen.Edict.Core.Schedules.Invokable_IEdictScheduleFireable_GrainReference_39BFA593",
        "OrleansCodeGen.Edict.Core.Schedules.Invokable_IEdictScheduleFireable_GrainReference_612CF67A",
        "OrleansCodeGen.Edict.Core.Schedules.Invokable_IEdictScheduleFireable_GrainReference_8DABBE0C",
