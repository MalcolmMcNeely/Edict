...
public sealed class IdempotencyWindowSizeClusterCollection
    : ICollectionFixture<IdempotencyWindowSizeClusterFixture>
{
    public const string Name = "IdempotencyWindowSizeCluster";
}
