...
// wiring the full real-Azure stack — including the grain-backed dead-letter
// forensic facade this asserts resolves.
...
{
    [Fact]
    public void AddEdictAzureDeadLetterRepository_ShouldResolveGrainBackedFacade()
    {
        var repo = fixture.Cluster.Client.ServiceProvider
            .GetRequiredService<IEdictDeadLetterRepository>();

        Assert.IsType<GrainBackedDeadLetterRepository>(repo);
    }
}
