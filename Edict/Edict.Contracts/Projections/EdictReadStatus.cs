...
public enum EdictReadStatus
{
    ...
    /// <summary>A cursor was supplied and the named correlation's first effect on this projection is visible.</summary>
    CursorReached = 1,

    /// <summary>
    /// A cursor was supplied but the wait elapsed before the correlation became
