...
/// Wraps the chain-stable conversation id the framework minted for the Command, so
...
/// conversation id build a cursor without round-tripping <c>Accepted</c>.
/// </summary>
/// <param name="ConversationId">The chain-stable conversation id this cursor names.</param>
[MessagePackObject(keyAsPropertyName: true)]
public readonly record struct EdictCursor(Guid ConversationId);
