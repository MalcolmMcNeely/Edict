...
/// <summary>
/// Substrate-agnostic conformance for the saga absolute-lifetime cap firing
...
/// The assertion observes the durable, externally-visible outcome (the delivered
/// compensation), not the saga's internal lifecycle slot. The deferred fact
/// proves the same holds when the triggering Event arrives oversized (the
/// claim-check pointer-envelope path), where the cap arms at staging.
/// </summary>
