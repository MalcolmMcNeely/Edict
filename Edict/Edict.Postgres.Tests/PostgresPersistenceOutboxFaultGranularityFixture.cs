...
/// </summary>
public sealed class PostgresPersistenceOutboxFaultGranularityFixture : PostgresPersistenceFixtureBase
{
...
public sealed class PostgresPersistenceOutboxFaultGranularityCollection
    : ICollectionFixture<PostgresPersistenceOutboxFaultGranularityFixture>
{
    public const string Name = "PostgresPersistenceOutboxFaultGranularity";
}
