...
// Sibling of PostgresClaimCheckClusterFixture tuned to dead-letter quickly: a
// hand-staged pointer envelope fetched through the Postgres claim-check store
// raises PayloadMissing, and OutboxMaxAttempts=3 with a tiny backoff exhausts
// retries within a few reminder ticks so the promotion-count metric fires.
public sealed class PostgresMissingClaimCheckClusterFixture : ConformanceFixture
{
...
public sealed class PostgresMissingClaimCheckCollection
    : ICollectionFixture<PostgresMissingClaimCheckClusterFixture>
{
    public const string Name = "PostgresMissingClaimCheck";
}
