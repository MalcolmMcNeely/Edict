...
/// <summary>
/// Persistence-axis fixture that wraps the real Postgres claim-check store with
...
/// eventually returns.
/// </summary>
public sealed class PostgresPersistenceClaimCheckTransientRecoveryFixture : PostgresPersistenceFixtureBase, IClaimCheckStoreFixture
{
...
public sealed class PostgresPersistenceClaimCheckTransientRecoveryCollection
    : ICollectionFixture<PostgresPersistenceClaimCheckTransientRecoveryFixture>
{
    public const string Name = "PostgresPersistenceClaimCheckTransientRecovery";
}
