...
/// </summary>
public sealed class PostgresPersistenceDeadLetterDegradeFixture : PostgresPersistenceFixtureBase
{
...
public sealed class PostgresPersistenceDeadLetterDegradeCollection
    : ICollectionFixture<PostgresPersistenceDeadLetterDegradeFixture>
{
    public const string Name = "PostgresPersistenceDeadLetterDegrade";
}
