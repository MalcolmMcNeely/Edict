...
/// Mirrors <see cref="EdictProjectionGenerator"/> — the dispatch seam
/// (<c>DispatchEventAsync</c>) is shared on the idempotency root, so the only
/// emitted difference is the grain-interface root (ADR 0020).
/// <para>
